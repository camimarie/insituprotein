"""
Description: This file contains the implementation of a queue data structure for processing protein sequences, specifically for sampling in 20 amino acids.
"""
...
from sample.SampleTrie import Trie
import numpy as np

FIXED_AA = "J"
ANCHORED_AA = "Z"
UNCONJUGATED_AA = "B"
BINDERS = "ARNDCEQGHILKMFPSTWYV" # 20 aas for sampling
        ...
        while round_count < edman_rounds:
            ...
            if conjugated:
                if random.random() >= edman_cleave_fail_prob:
                    ...
                    conjugated = False
                # else: cleavage failure = keep same residue but conjugation remains
