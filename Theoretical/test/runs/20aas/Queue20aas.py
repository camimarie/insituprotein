"""
Description: This file contains the implementation of a queue data structure for processing protein sequences, specifically for testing in 20 amino acids.
"""
...
ANCHORED_AA = "Z"
UNCONJUGATED_AA = "B"
BINDERS = "ARNDCEQGHILKMFPSTWYV" # 20 aas
