"""
Description: This file contains the implementation of a queue data structure for processing protein sequences, specifically for testing in 15 amino acids.
"""
...
ANCHORED_AA = "Z"
UNCONJUGATED_AA = "B"
BINDERS = "ANDEQGILKFPSTYV" # 15 aas
